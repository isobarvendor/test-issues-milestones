<template>
  <div class="prize-inner-wrapper" :id="prize.prizeType">
    ...
    <div class="prize-title" v-html="prize.text"></div>
    <div
      :class="
        prize.luckyDraw ? 'prize-content prize-lucky-draw' : 'prize-content'
      "
    >
    ...
    <div
      v-if="showParticipateAgain"
      class="prize-button-area center"
      style="margin-top:40px;"
    >
      <v-btn @click="playAgain" :id="'Participate_Again_' + prize.prizeType">{{
...
.prize-chance
  .wrapper
  .prize-inner-wrapper
  .prize-content.prize-lucky-draw
  .prize-desc-wrapper
  .prize-desc
  .desc-text {
