let language = {
  ...
  th: {
    ...
    periodDescription:
      "กิจกรรมเปิดจังหวะซ่าในตัวคุณได้สิ้นสุดลงแล้ว ขอบคุณที่สนใจและเข้าร่วมกิจกรรมกับ โค้ก",
    signInButton: "SIGN IN <BR/><small>to win prizes</small>",
    menu: {
      home: "หน้าหลัก",
      privacy: "นโยบายข้อมูลส่วนบุคคล",
      terms: "เงื่อนไขการเข้าร่วมกิจกรรม",
      logout: "ออกจากระบบ",
      myRewards: "รางวัลของฉัน",
      winners:"ผู้โชคดีรางวัลใหญ่รายสัปดาห์"
    },
    countdown: {
      days: "DAYS",
      hrs: "HRS",
    ...
    submissionText: {
      ...
      acceptTerm:
        'ข้าพเจ้ายอมรับ<a href="/tnc" target="_blank">ข้อกำหนดและเงื่อนไขของกิจกรรมส่งเสริมการขายนี้</a> <a href="/privacy" target="_blank"> นโยบายความเป็นส่วนตัว</a> และยินยอมให้ใช้ข้อมูลส่วนบุคคลของข้าพเจ้าที่ได้ลงทะเบียนในการเข้าร่วมกิจกรรมส่งเสริมการขาย',
      acceptPrivacy:
        'ข้าพเจ้ายอมรับ<a href="/tnc" target="_blank">ข้อกำหนดและเงื่อนไขของกิจกรรมส่งเสริมการขายนี้</a> <a href="/privacy" target="_blank"> นโยบายความเป็นส่วนตัว</a> และยินยอมให้ใช้ข้อมูลส่วนบุคคลของข้าพเจ้าที่ได้ลงทะเบียนในการเข้าร่วมกิจกรรมส่งเสริมการขายนี้',
      declareAge:
        "ข้าพเจ้ามีอายุ 20 ปี หรือมากกว่า และในกรณีที่ข้าพเจ้ามีอายุต่ำกว่า 20 ปี ข้าพเจ้ายืนยันว่าได้รับความยินยอมจากผู้ปกครองตามกฏหมายในการเข้าร่วมกิจกรรมตามข้อกำหนดและเงื่อนไขของกิจกรรมส่งเสริมการขายนี้​",
      declareMarketing:
        "ข้าพเจ้ายินยอมให้ใช้ข้อมูลส่วนบุคคลของข้าพเจ้าเพื่อวัตถุประสงค์เกี่ยวกับการรับข้อมูลข่าวสารการตลาดและการโฆษณาประชาสัมพันธ์จากโคคา-โคล่า",
      enterCode: "ใส่รหัส 9 หลักใต้ฝาแฟนต้า",
      tooltipText: "ใส่รหัส 9 หลักใต้ฝาโค้ก ที่นี่",
      phoneTooltip:
        "โปรดใส่เบอร์มือถือ 9 หลักหลัง +66 โดยไม่ต้องใส่เลข 0 เช่น ถ้าเบอร์ของคุณคือ 081-123-4567 โปรดใส่ +66811234567",
      buttonText: "กดส่งรหัสใต้ฝา",
      errorTerm: "โปรดยอมรับข้อกำหนดและเงื่อนไขของเรา",
      errorPolicy: "Please accept our privacy policies",
      errorDeclare: "กรุณาประกาศว่าคุณมีอายุมากกว่า 20 ปี",
      errorPinCode:
        "ขออภัยครับ รหัสของคุณไม่ถูกต้อง โปรดใส่รหัส 9 หลักใต้ฝาโค้กใหม่อีกครั้ง หรือไปที่หน้า รางวัลของฉัน เพื่อดูรางวัลที่คุณได้รับ",
      errorPinCode1:
        "ขออภัยครับ รหัสของคุณไม่ถูกต้อง โปรดใส่รหัส 9 หลักใต้ฝาโค้กใหม่อีกครั้ง หรือไปที่หน้า รางวัลของฉัน เพื่อดูรางวัลที่คุณได้รับ",
      errorPinCode2:
        "ขออภัยครับ รหัสของคุณไม่ถูกต้อง โปรดใส่รหัส 9 หลักใต้ฝาโค้กใหม่อีกครั้ง หรือไปที่หน้า รางวัลของฉัน เพื่อดูรางวัลที่คุณได้รับ",
