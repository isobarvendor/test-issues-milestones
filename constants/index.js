...
let language =
{
  ...
  th:{
      ...
      periodDescription:"ระยะเวลาร่วมกิจกรรม 1 มีนาคม – 31 พฤษภาคม 2564 เพียงแค่ซื้อผลิตภัณฑ์โค้กที่ร่วมรายการแล้วนำโค้ดใต้ฝาสีทองมากรอก ก็รับไปเลยทันที JOOX VIP 1 สัปดาห์ (สิทธิ์มีจำนวนจำกัด 1 คน ต่อ 1 สิทธิ์) และลุ้นรับรางวัลสุดซ่าอื่นๆจากการจับรางวัลทุกสัปดาห์ เพียงแค่ทำตามขั้นตอนด้านล่าง",
      signInButton:"SIGN IN <BR/><small>to win prizes</small>",
      menu:{
        home:"หน้าหลัก",
      ...
      submissionText:{
        ...
        phoneTooltip:"โปรดใส่เบอร์โทรศัพท์มือถือที่ถูกต้องเพื่อให้เราสามารถติดต่อกลับคุณได้ในกรณีที่คุณได้รับรางวัลสุดซ่ารายสัปดาห์",
